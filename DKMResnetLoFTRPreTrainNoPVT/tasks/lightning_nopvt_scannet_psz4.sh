...
#SBATCH --job-name lightning_nopvt_scannet_psz4
#SBATCH -o /mnt/home/zhusheng/slurm_log/lightning_nopvt_scannet_psz4.log
...
--nproc_per_node 1 DKMResnetLoFTRPreTrainNoPVT/lightning_nopvt_scannet.py \
...
--tag AblatePretrain/lightning_nopvt_scannet_psz4 \
--minoverlap-scannet 0.3 --mask-patch-size 4 --mask-ratio-scannet 0.99
