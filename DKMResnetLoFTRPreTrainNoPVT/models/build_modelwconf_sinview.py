...
from DKMResnetLoFTRPreTrainNoPVT.loftr import LoFTRWConfSinview, default_cfg
...
def DKMv2wconfSinView(uselinearattention=False):
    h, w = 384, 512
    # Init LoFTR
    ...
    loftr = LoFTRWConfSinview(config=_default_cfg)
