...
def main(config):
    ...
    ckpt_path = '/home/shengjie/Documents/MultiFlow/SimMIMDenseMatch/checkpoints/simmim_pretrain/AblateCoaseCorr/lightning_scannet_ref/ckpt_epoch_20.pth'
    ckpt = torch.load(ckpt_path, map_location='cpu')
    incompactible = model.load_state_dict(ckpt['model'], strict=True)
    model.train()

    os.makedirs('/media/shengjie/disk1/visualization/EMAwareFlow/pmim_ablate_ref', exist_ok=True)
    ...
    for x in tqdm.tqdm(img_keys):
        ...
        Image.fromarray(vls).save(os.path.join('/media/shengjie/disk1/visualization/EMAwareFlow/pmim_ablate_ref', '{}.png'.format(str(x))))
