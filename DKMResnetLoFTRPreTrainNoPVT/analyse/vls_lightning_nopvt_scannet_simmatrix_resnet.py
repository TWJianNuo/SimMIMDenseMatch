...
class ResNet50(nn.Module):
    ...
    def extrac_feature(self, img1_scannet, img2_scannet):
        feats1 = self.forward(img1_scannet)
        feats2 = self.forward(img2_scannet)

        return feats1[8], feats2[8]
...
def main(config):
    ...
    for x in tqdm.tqdm(img_keys):
        ...
        vls_fold = os.path.join('/media/shengjie/disk1/visualization/EMAwareFlow/pmim_ablate_confvls_resnet', '{}'.format(str(x)))
