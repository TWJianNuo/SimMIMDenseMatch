...
with torch.no_grad():
    for idx, (imagenet_batch, scannet_batch) in enumerate(zip(dataloader_imagenet, dataloader_scannet)):
        ...
        loss, x_rec = model(img1_scannetnet, mask_scannet, img2_scannetnet)
