...
def main(config):
    ...
    for epoch in range(config.TRAIN.START_EPOCH, config.TRAIN.EPOCHS):
        ...
        data_loader_train_imagenetaug = DataLoader(imagenetaug, config.DATA.BATCH_SIZE,
        ...
        train_one_epoch(config, model, data_loader_train_imagenetaug, optimizer, epoch, lr_scheduler, writer)
...
def train_one_epoch(config, model, data_loader_imagenetaug, optimizer, epoch, lr_scheduler, writer):
    model.train()
    optimizer.zero_grad()
