...
from StandardpMIMMega.datasets.scannet import build_loader_scannet
...
def parse_option():
    ...
    parser.add_argument('--minoverlap', type=float, default=0.3)
...
def train_one_epoch(config, model, data_loader_scannet, optimizer, epoch, lr_scheduler, writer):
    ...
    for idx in range(num_steps):
        ...
        loss, x_rec = model(img1_scannet, mask_scannet, img2_scannet)
